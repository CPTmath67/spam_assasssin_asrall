...
plugins non officiels ont vu le jour. Cela inclut également les plugins commerciaux(Plugins utilisant des licences non-libres). 
...
\begin{description}
 ...
 \item [SAGrey]  Ce plugin est un outil de greylist, qui s'execute en deux phases.Son but est de permettre 
 ...
 \begin{itemize}
  ...
  et de ne pas augmenter la taille des bases regroupant les expéditeurs connus.
 \end{itemize}

 \item [MTX] Une liste blanche de DNS distribuées.
 \end{description}
...
\begin{itemize}
\paragraph{Au travers de MTA}
\item Procmail
\item qmail
\item sendmail
\item Exim

\paragraph{Au travers de MUA}
\item Thunderbird
\item kmail
\item Evolution
\end{itemize}
